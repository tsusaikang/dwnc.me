...
- 계정 번호 전용 보관·복구 시험 123개, 읽기 전용 열쇠 전달 시험 81개와 시험용 Worker 관리 열쇠 시험 378개를 통과했다. 중단 복구 전용 1,023개와 실제 runner→복구 자식 139개를 포함해, 자동 집계한 최신 전체 Cloudflare 회귀시험 26개 묶음·8,641개 확인을 모두 통과했다. 실제 Keychain·클립보드·Cloudflare·R2 접근은 각 전용 시험의 계수에서 0회다.
