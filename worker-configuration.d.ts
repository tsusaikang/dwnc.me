/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings` (hash: 99d9fefc9a2780c7b856c40727007775)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DWNC_DEPLOYMENT_ENVIRONMENT">> {}
}
